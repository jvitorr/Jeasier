...
public class GeneratorLayout {
	...
	public void generate(TemplateFormat template) throws URISyntaxException, IOException {
		...
		System.out.println(EasyJavaAplication.class.getResource(template.getPathVendors()).getFile());
		System.out.println(EasyJavaAplication.class.getResource(template.getPathLayoutFragments()).getFile());
		// System.out.println(EasyJavaAplication.class.getResource(template.getPathMainlyLayout()).getFile());
		System.out.println(EasyJavaAplication.class.getResource(template.getPathResourcesLayout()).getFile());
		...
		FileUtils.copyDirectory(
				new File(EasyJavaAplication.class.getResource(template.getPathLayoutFragments()).getFile()),
		...
		FileUtils.copyDirectory(new File(EasyJavaAplication.class.getResource(template.getPathVendors()).getFile()),
				new File(pathResourcesVendors));
		FileUtils.copyDirectory(
				new File(EasyJavaAplication.class.getResource(template.getPathResourcesLayout()).getFile()),
